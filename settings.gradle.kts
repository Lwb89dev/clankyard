...
include(":build:api")
project(":build:api").projectDir = file("ondevice-build/api")
include(":build:runtime")
project(":build:runtime").projectDir = file("ondevice-build/runtime")
include(":build:engine")
project(":build:engine").projectDir = file("ondevice-build/engine")
